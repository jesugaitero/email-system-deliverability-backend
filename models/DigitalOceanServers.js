...
const digitalOceanServersSchema = new Schema({
  key: {
    type: String,
    trim: true,
  },
...
const DigitalOceanServers =  mongoose.model("DigitalOceanServers", digitalOceanServersSchema);
module.exports = DigitalOceanServers;